						...
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									...
									<span class="team_manager_hint"><?php echo __('Select Team Showcase Category.( <span style="color:red">Multiple categories select option only available in pro version</span>)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<span class="team_manager_hint"><?php echo __('Choose Your Team Showcase Style. all style is not available in free version. upgrade pro version to unlock all features.', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									...
									<span class="team_manager_hint"><?php echo __('Choose member image size default or custom size.', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<select name="team_manager_free_post_column" id="team_manager_free_post_column" class="timezone_string">
										...
										<option disabled value="4" <?php if ( isset ( $team_manager_free_post_column ) ) selected( $team_manager_free_post_column, '4' ); ?>><?php _e('4 Column (Only Pro)', 'team-manager-free')?></option>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<input type="number" name="team_manager_free_margin_bottom" id="team_manager_free_margin_bottom" maxlength="4" class="timezone_string" value="<?php  if($team_manager_free_margin_bottom !=''){echo $team_manager_free_margin_bottom; }else{ echo '15';} ?>"> <span style="color: red;">Available Pro Version</span>
									<span class="team_manager_hint"><?php echo __('Choose team member column margin bottom size. default font size (15px)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<input type="number" name="team_manager_free_margin_lfr" id="team_manager_free_margin_lfr" maxlength="4" class="timezone_string" value="<?php  if($team_manager_free_margin_lfr !=''){echo $team_manager_free_margin_lfr; }else{ echo '5';} ?>"><span style="color: red;">Available Pro Version</span>
									<span class="team_manager_hint"><?php echo __('Choose team member column margin left/Right size. default font size (5px)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<select name="team_manager_free_social_target" id="team_manager_free_social_target" class="timezone_string">
										<option value="_self" <?php if ( isset ( $team_manager_free_social_target ) ) selected( $team_manager_free_social_target, '_self' ); ?>><?php _e('Open Same Page', 'team-manager-free')?></option>
										<option value="_blank" <?php if ( isset ( $team_manager_free_social_target ) ) selected( $team_manager_free_social_target, '_blank' ); ?>><?php _e('Open New Page', 'team-manager-free')?></option>
									</select>
					...
					<div class="option-box">
						...
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<input type="number" name="team_manager_free_header_font_size" id="team_manager_free_header_font_size" maxlength="4" class="timezone_string" value="<?php  if($team_manager_free_header_font_size !=''){echo $team_manager_free_header_font_size; }else{ echo '15';} ?>">
									<span class="team_manager_hint"><?php echo __('Select team member name font size. default font size (15px)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<input type="number" name="team_manager_free_designation_font_size" id="team_manager_free_designation_font_size" maxlength="4" class="timezone_string" value="<?php  if($team_manager_free_designation_font_size !=''){echo $team_manager_free_designation_font_size; }else{ echo '12';} ?>">
									<span class="team_manager_hint"><?php echo __('Select Team member Designation Font Size. default font size (12px)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td style="vertical-align:middle;">
									<input type="number" name="team_manager_free_biography_font_size" id="team_manager_free_biography_font_size" maxlength="4" class="timezone_string" value="<?php  if($team_manager_free_biography_font_size !=''){echo $team_manager_free_biography_font_size; }else{ echo '12';} ?>">
									<span class="team_manager_hint"><?php echo __('Select Team member Biography Font Size. default font size (12px)', 'team-manager-free'); ?></span>
								</td>
							</tr>
							...
							<div class="help-support">
								<div class="support-items">
									...
									<div class="support-details">
										<p>If you need any helps, please don't hesitate to post it on WordPress.org Support Forum or Themepoints Support Forum</p>
									</div>
...
<!-- 								<div class="support-items">
									<div class="support-title">
										<?php //echo __('Documentation', 'team-manager-free'); ?>
									</div>
									<div class="support-details">
										<p>If you need any helps, please do not hesitate to post it on WordPress.org Support Forum or Themepoints Support Forum</p>
									</div>
									<div class="support-link">
										<a href="#" class="button-1">Setup Team</a>
										<a href="#" class="button-1">Team Sortable</a>
									</div>
								</div> -->
								<div class="support-items">
									<div class="support-title">
