...
[BUG]   Fixan issue where sometimes the background slide could not be uploaded unless the user had small image generation enabled (Settings -> Media -> Media Settings). It is now possible to upload regardless of this option.
